      ...
      <section>
        ...
        >
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            ...
            >
              <div className="absolute w-28 left-0 -top-20 max-lg:hidden">
                <div
                  className="absolute inset-x-0 bottom-0 bg-gradient-to-t via-slate-50/50
                 from-slate-50 h-28"
                />
              ...
              <p
                className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance
              md:text-wrap
              "
              >
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                ...
                <div className="flex flex-col justify-between items-center sm:items-start">
                  <div className="flex gap-0.5">
                    <Star className="h-4 w-4 text-gray-600 fill-green-600" />
                    <Star className="h-4 w-4 text-gray-600 fill-green-600" />
                    <Star className="h-4 w-4 text-gray-600 fill-green-600" />
                    <Star className="h-4 w-4 text-gray-600 fill-green-600" />
                    <Star className="h-4 w-4 text-gray-600 fill-green-600" />
                  ...
                  <p>
                    <span className="font-semibold">1,223</span> happy customers
                  </p>
                </div>
              </div>
            </div>
          ...
          <div
            className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0
          lg:mt-20 h-fit"
          >
            <div className="relative md:max-w-xl">
              ...
              -top-20 select-none max-sm:hidden max-xl:hidden"
                draggable="false"
              />
              <img
                src="/line.png"
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            <h2
              className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold
            text-5xl md:text-6xl text-gray-900"
            >
              What our{" "}
